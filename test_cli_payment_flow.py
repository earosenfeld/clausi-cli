...
# Add the clausi_cli directory to the path
sys.path.insert(0, str(Path(__file__).parent / "clausi_cli"))

from clausi_cli.scan import handle_scan_response, handle_payment_required, check_payment_required
from clausi_cli.config import get_api_token, save_api_token
import requests
